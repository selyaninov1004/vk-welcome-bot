...
def vk_bot():
    ...
    if data["type"] == "group_join":
        ...
        send_messagesend_message(user_id, 'Привет! Добро пожаловать на кафедру "Социальной и молодежной политики". Если хочешь подробнее узнать о поступлени, нашей кафедре или универститете, то можешь посмотреть контакты и ссылки в "Подробная информация". Удачи!')
        return "ok"
